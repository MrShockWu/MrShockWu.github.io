...
// 节点建模中的业务节点、审批节点属性
var BUS_NODE_TYPES = [
    { type: 'userRule', descp: '选人规则', value: '1' },
    { type: 'functionList', descp: '功能清单', value: '8' },
    { type: 'taskOptionTime', descp: '任务处理时间', value: '13' },
    // { type: 'taskOptionTimeRule', descp: '任务处理时间规则', value: '14' },
    // { type: 'timeOutWarn', descp: '超时预警机制', value: '21' },
    { type: 'timeOutOprate', descp: '任务超时处理机制', value: '14' },
    { type: 'notifyType', descp: '任务通知机制', value: '23' },
    // { type: 'maxCheckOutNum', descp: '最大检出数', value: '44' },
    // { type: 'timeStart', descp: '定时启动时长', value: '24' },
    // { type: 'accessoryProp', descp: '附件属性', value: '25' },
    // { type: 'selectOption', descp: '可选意见', value: '26' },
    { type: 'taskAllocationType', descp: '任务分配机制', value: '27' },
    // { type: 'featureTaskNameDisplay', descp: '特性任务名称展示', value: '11' },
    { type: 'intputCondition', descp: '节点进入条件', value: '4' },
    { type: 'outputCondition', descp: '节点离开条件', value: '5' },
    { type: 'startTaskEvent', descp: '节点进入触发事件', value: '30' },
    { type: 'endTaskEvent', descp: '节点离开触发事件', value: '31' },
    { type: 'cancelTaskEvent', descp: '节点任务取消触发事件', value: '32' },
    { type: 'recallTaskEvent', descp: '节点任务撤回触发事件', value: '33' },
    { type: 'backTaskEvent', descp: '节点任务退回触发事件', value: '34' },
    // { type: 'channelNodeCtrlList', descp: '节点渠道控制列表', value: '35' },
    { type: 'nodeAutoRepeatProcess', descp: '处理人重复自动处理', value: '36' },
    { type: 'checkInOut', descp: '任务池任务属性', value: '37' },
    { type: 'channelNodeQueList', descp: '节点渠道查询列表', value: '38' },
    { type: 'taskRecallCrtl', descp: '节点撤回控制', value: '39' }
];
// 节点建模中的会签节点属性
var SIGN_NODE_TYPES = [
    { type: 'userRule', descp: '选人规则', value: '1' },
    { type: 'functionList', descp: '功能清单', value: '8' },
    { type: 'taskOptionTime', descp: '任务处理时间', value: '20' },
    // { type: 'taskOptionTimeRule', descp: '任务处理时间规则', value: '14' },
    // { type: 'timeOutWarn', descp: '超时预警机制', value: '21' },
    { type: 'timeOutOprate', descp: '任务超时处理机制', value: '12' },
    { type: 'notifyType', descp: '任务通知机制', value: '23' },
    // { type: 'timeStart', descp: '定时启动时长', value: '24' },
    // { type: 'accessoryProp', descp: '附件属性', value: '25' },
    // { type: 'selectOption', descp: '可选意见', value: '26' },
...
// 节点建模的自动节点
var AUTO_NODE_TYPES = [
    { type: 'autoNodeServiceCall', descp: '自动节点服务调用', value: '20' },
    { type: 'startTaskEvent', descp: '节点进入触发事件', value: '30' },
    { type: 'endTaskEvent', descp: '节点离开触发事件', value: '31' },
    { type: 'intputCondition', descp: '节点进入条件', value: '4' },
    { type: 'outputCondition', descp: '节点离开条件', value: '5' },
...
// 节点建模的子节点
var SUB_NODE_TYPES = [
    { type: 'subprocessSelection', descp: '子流程选择列表', value: '20' },
    { type: 'intputCondition', descp: '子流程进入条件', value: '4' },
    { type: 'outputCondition', descp: '子流程离开条件', value: '5' },
];
// 流程建模扩展属性
var PROCESS_MODEL_EXTEND_PROPS = [
    { type: 'skipFistNode', descp: '首节点跳过', value: '30' },
    { type: 'checkPer', descp: '启动节点前台选人', value: '27' },
    { type: 'callBackJump', descp: '打回重提跳转', value: '42' },
    { type: 'confirInfo', descp: '启动节点路由提示', value: '28' },
    { type: 'personPro', descp: '启动节点人工路由', value: '29' },
    { type: 'timeToStart', descp: '定时启动时长', value: '31' },
    // { type: 'processTimeOutWarn', descp: '流程超时预警机制', value: '46' },
    { type: 'maxTime', descp: '流程最长处理时间', value: '13' },
    // { type: 'maxTimeRule', descp: '流程最长处理时间规则', value: '13' },
    // { type: 'checkInOut', descp: '检入检出', value: '42' },
    { type: 'outTimeExecution', descp: '流程超时处理机制', value: '33' },
    { type: 'startCondition', descp: '流程启动条件', value: '4' },
    { type: 'endCondition', descp: '流程结束条件', value: '5' },
    { type: 'flowStartEvent', descp: '流程启动触发事件', value: '36' },
    { type: 'flowEndEvent', descp: '流程正常结束触发事件', value: '37' },
    { type: 'flowEndErrorEvent', descp: '流程异常结束触发事件', value: '38' },
    { type: 'hangUpEvent', descp: '流程挂起触发事件', value: '39' },
    { type: 'recoverEvent', descp: '流程挂起恢复触发事件', value: '40' },
    { type: 'cancelEvent', descp: '流程取消终止触发事件', value: '41' },
    // { type: 'channelFlowCtrlList', descp: '流程渠道控制列表', value: '42' },
    { type: 'flowAutoRepeatProcess', descp: '处理人重复自动处理', value: '43' },
    { type: 'isFlowAuthorize', descp: '任务转授权允许', value: '44' },
    { type: 'notifyForProcessCreater', descp: '事件中心ID配置', value: '45' }
];
// 流程检入检出属性
var CHECK_IN_OUT_VALUE = [
    { type: '0', descp: '检出检入' },
    { type: '1', descp: '只检出禁止检入' }
];
// 超时处理机制
var TIMEOUT_HANDING_TYPES = [
    { type: '0', descp: '人工干预处理' },
    { type: '1', descp: '超时自动异常终止' },
    { type: '2', descp: '超时自动正常终止' }
];
// 事件服务调用类型
...
var RULE_TYPES = [
    { type: "1", descp: "选人策略规则" },
    { type: "2", descp: "流程分支规则" },
    { type: "3", descp: "流程编码匹配规则" },
    { type: "4", descp: "进入条件确认规则" },
    { type: "5", descp: "离开条件确认规则" },
    // { type: "6", descp: "流转分支选人规则" },
    { type: "7", descp: "子流程选取规则" },
    { type: "8", descp: "功能清单规则" },
    { type: "9", descp: "启动条件规则" },
    { type: "10", descp: "结束条件规则" },
    { type: "11", descp: "任务名称规则" },
    { type: '12', descp: '超时换人规则' },
    { type: '13', descp: '流程最长处理时间规则' },
    { type: '14', descp: '任务处理时间规则' }
];
// 节点建模附件属性
...
var TASK_TIME_OUT_HANDLE_TYPE = [
    ...
    { type: '7', descp: '超时服务事件' },
    { type: '8', descp: '超时任务回收' },
    { type: '9', descp: '超时任务霸屏提醒' },
    { type: '10', descp: '超时处理机制规则映射' }
];
// 会签节点建模任务分配机制
...
var TIMEOUT_WARNING_TYPE = [
    { type: 'sms', descp: '短信通知预警' },
    { type: 'email', descp: '邮件通知预警' }
];
// 任务通知机制
var TASK_NOTIFY_TYPE = [
    { type: 'no', descp: '无需通知' },
    { type: 'sms', descp: '短信通知' },
    { type: 'email', descp: '邮件通知' },
    { type: 'eventTrigger', descp: '事件中心' }
];
// 消息模板类型
...
var MESSAGE_TEMPLATE_TYPE2 = [
    ...
    { type: 'sms', descp: '短信' },
    { type: 'email', descp: '邮件' },
    { type: 'notify', descp: '处理结果通知' }
];
// 异常策略 异常类型
var EXCEPTION_TYPE = [
    { type: 'P0', descp: '属性配置异常' },
    { type: 'S1', descp: '服务调用异常' },
    { type: 'D2', descp: '业务数据异常' },
    { type: 'T3', descp: '判定超时异常' },
    { type: 'F4', descp: '系统功能异常' }
];
// 异常运行状态
...
var EXCEPTION_PATTERN = [
    { type: '00', descp: '分支模式属性配置错误' },
    { type: '01', descp: '聚合模式属性配置错误' },
    { type: '02', descp: '选人规则属性未配置' },
    { type: '03', descp: '任务编码属性未配置' },
    { type: '04', descp: '服务编码属性未配置' },
    { type: '05', descp: '通知格式属性未配置' },
    { type: '10', descp: '选人适配服务调用失败' },
    { type: '11', descp: '待办任务推送服务失败' },
    { type: '12', descp: '消息通知服务调用失败' },
    { type: '20', descp: '选人适配数据为空' },
    { type: '30', descp: '超时标准1异常' },
    { type: '31', descp: '超时标准2异常' },
    { type: '32', descp: '超时标准3异常' },
    { type: '40', descp: '系统数据库异常' },
    { type: '50', descp: '系统功能异常' }
];
// 屏蔽后的异常模式
...
var GENERAL_PARAMS_TYPES = [
    { type: '10', descp: '事项大类' },
    { type: '01', descp: '事项小类' },
    { type: 'C0', descp: '业务数据比较参数' },
    { type: 'F0', descp: '流程编码事项' },
    { type: 'G0', descp: '超时通知策略' }
];
// 通用参数类型
...
var GLOBAL_NOTIFY_TYPES = [
    { type: 'timeoutAfter', descp: '超时通知' },
    { type: 'timeoutBefore', descp: '超时预警通知' },
    { type: 'timeoutBeforeAfter', descp: '超时通知+预警通知' }
];
// 节点类型
var TASK_NODE_TYPES = [
    { type: '', descp: '全部节点' },
    { type: 'task', descp: '业务节点' },
    { type: 'approve', descp: '审批节点' },
    { type: 'sign', descp: '会签节点' },
    { type: 'auto', descp: '自动节点' },
    { type: 'subproc', descp: '子流程节点' }
];
// 任务处理状态
...
var TASK_HANDLE_TYPES = [
    { type: '0', descp: 'URL地址调用' },
    { type: '1', descp: '服务方法调用' }
];
// 流程结束类型
var PROCESS_END_TYPES = [
    { type: '', descp: '全部' },
    { type: 'cancel', descp: '取消' },
    { type: 'complete', descp: '正常结束' }
];
// 是否流程结束类型
var IS_PROCESS_END = [
    { type: '0', descp: '正常' },
...
var MANAGE_TASKS_TYPES = [
    ...
    { type: 'M2', descp: '任务终止' },
    { type: 'M3', descp: '任务跳转' },
    { type: 'M4', descp: '任务挂起恢复' },
    { type: 'M5', descp: '更换处理人员' },
    { type: 'M6', descp: '任务催办' },
    { type: 'M7', descp: '任务超时延长' },
    { type: 'M8', descp: '强制终止' }
];
// 流程终止类型类型
...
var EXCEPTION_HANDLE_USR_TYPES = [
    { type: '0', descp: '指定给流程创建者' },
    { type: '1', descp: '指定给流程发起人' },
    { type: '2', descp: '指定给上节处理人' },
    { type: '3', descp: '指定给特定人员' },
    { type: '4', descp: '超时通知人员' }
];
// 异常通知方式
...
var EXCEPTION_AUTO_HANDLE = [
    { type: '0', descp: '原服务重复调用' },
    { type: '1', descp: '调用指定服务处理' }
];
// 处理结果
var APPROVE_RESULT = [
    { type: '0', descp: '同意' },
...
// 流程节点业务状态信息  事件类型编码
var EVENT_TYPE_CODE = [
    { type: 'EVENT_P1', descp: '流程启动触发' },
    { type: 'EVENT_P2', descp: '流程正常结束触发' },
    { type: 'EVENT_P3', descp: '流程异常结束触发' },
    { type: 'EVENT_P4', descp: '流程挂起触发' },
    { type: 'EVENT_P5', descp: '挂起恢复触发' },
    { type: 'EVENT_P6', descp: '终止取消触发' },
    { type: 'EVENT_T0', descp: '自动服务调用触发' },
    { type: 'EVENT_T1', descp: '任务生成触发' },
    { type: 'EVENT_T2', descp: '任务完成触发' },
    { type: 'EVENT_T3', descp: '任务回退触发' },
    { type: 'EVENT_T4', descp: '任务撤回触发' }
];
// 流程节点业务状态信息  状态类型
var STATUS_TYPE = [
    { type: '00', descp: '节点业务状态' }
];
// 规则引擎决策集类型
var DECISION_TYPE = [
    { type: 'rule', descp: '向导式' },
...
var RECIPIENT_RETURN = [
    { type: '3', descp: '领用后不可退回任务池' },
    { type: '2', descp: '领用后可退回任务池' }
];
// 事项优先级
var ADVANCE_LEVEL = [
    { type: '0', descp: '正常' },
...
// 节点任务追回机制
var CRTL_TYPE = [
    { type: '1', descp: '实例未结束可追回' },
    { type: '0', descp: '下节任务未处理可追回' }
];
// 查看状态
var VIEW_FLAG = [
    { type: '0', descp: '未查看' },
...
// 全局事件 时间类型
var EVENT_TYPE = [
    { type: 'isFlowAuthorize', descp: '转授权任务处理提醒' },
    { type: 'notifyForProcessCreater', descp: '流转动态提醒' }
];
// 授权内容
var VALID_FLAGS_DESCP = [
    { type: '0', descp: '授权流程处理' },
    { type: '1', descp: '授权流程及已有待办事项' }
];
// 生效方式
var UPDATE_VERSION_TYPE = [
    { type: true, descp: '即时生效' },
    { type: false, descp: '非即时生效' }
];
    ...
    if (data.returnCode.type === 'S') {
        if (op) {
            if (msgObj.message) {
                ...
                messageService.add({ severity: 'success', summary: '信息提示框', detail: (msgObj && msgObj.message) || data.returnCode.message });
            }
        }
        callBack();
    }
    else {
        messageService.add({ severity: 'error', summary: '信息提示框', detail: data.message || data.returnCode.message || (msgObj && msgObj.errorMsg) });
    }
}
function handleResult2(data, messageService, callBack, op, msgObj) {
    ...
    if (data.success) {
        if (op) {
            if (msgObj.message) {
                messageService.clear();
                messageService.add({ severity: 'success', summary: '信息提示框', detail: (msgObj && msgObj.message) || data.message });
            }
        }
        callBack();
    }
    else {
        messageService.add({ severity: 'error', summary: '信息提示框', detail: data.message || (msgObj && msgObj.errorMsg) });
    }
}
...
function handleError(err, messageService, callBack, msgObj) {
    ...
    messageService.clear();
    if (err.status === 0) {
        messageService.add({ severity: 'error', summary: '信息提示框', detail: '网络连接错误' });
    }
    else if (err.status === 404) {
        messageService.add({ severity: 'error', summary: '信息提示框', detail: '请求不存在' });
    }
    else if (err.status === 500) {
        messageService.add({ severity: 'error', summary: '信息提示框', detail: '系统错误' });
    }
    else {
        if (err instanceof rxjs_Rx__WEBPACK_IMPORTED_MODULE_0__["TimeoutError"]) {
            messageService.add({ severity: 'error', summary: '信息提示框', detail: '请求超时' });
        }
        else {
            messageService.add({ severity: 'error', summary: '信息提示框', detail: (msgObj && msgObj.errorMsg) || '未知错误' });
        }
    }
    callBack();
}
function handleErrorImportRule(err, messageService, callBack, msgObj) {
    ...
    messageService.clear();
    if (err.status === 0) {
        messageService.add({ severity: 'error', summary: '信息提示框', detail: "\u7F51\u7EDC\u8FDE\u63A5\u9519\u8BEF\u3001\u72B6\u6001\u7801" + err.status });
    }
    else if (err.status === 404) {
        messageService.add({ severity: 'error', summary: '信息提示框', detail: "\u8BF7\u6C42\u4E0D\u5B58\u5728\u3001\u72B6\u6001\u7801" + err.status });
    }
    else if (err.status === 500) {
        var returnMes = JSON.parse(err._body);
        messageService.add({ severity: 'error', summary: '信息提示框', detail: "" + returnMes.message });
    }
    else {
        if (err instanceof rxjs_Rx__WEBPACK_IMPORTED_MODULE_0__["TimeoutError"]) {
            messageService.add({ severity: 'error', summary: '信息提示框', detail: "\u8BF7\u6C42\u8D85\u65F6" });
